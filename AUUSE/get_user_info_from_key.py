...
# 사용자의 키를 이용하여 사용자 정보 조회
# user_key : 사용자의 키
def get_user_info_from_key(user_key):
    ...
    logger.info("Request get_user_info_from_key", extra=logger_data)

    # DB 에 로그를 남기기 위해 입력값, 요청값, api, function 명 등을 정의
    input = {}
    input['user_key'] = user_key
    log_request = "get_user_info_from_key"
    ...
    try:
        ...
        log_status = "REQUEST"
        output = data
        message = "get_user_info_from_key success"
        success_flag = "Y"
